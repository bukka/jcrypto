...
jcrypto_priv_key="$jcrypto_data_dir/private_key_ec_${jcrypto_curve_name}_main.der"
jcrypto_pub_key="$jcrypto_data_dir/public_key_ec_${jcrypto_curve_name}_main.der"
