...
jcrypto_out_enc_file="$jcrypto_this_dir/out-smime-auth-env-key-agree-stream-enc.txt"
jcrypto_out_plain_file="$jcrypto_this_dir/out-smime-auth-env-key-agree-stream-plain.txt"
