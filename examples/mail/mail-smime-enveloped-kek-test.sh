...
jcrypto_out_enc_file="$jcrypto_this_dir/out-smime-env-kek-enc.pem"
jcrypto_out_plain_file_from_jcrypto="$jcrypto_this_dir/out-smime-env-kek-plain-jc.txt"
jcrypto_out_plain_file_from_ossl="$jcrypto_this_dir/out-smime-env-kek-plain-ossl.txt"
jcrypto_out_ossl_enc_file="$jcrypto_this_dir/out-smime-env-kek-ossl-enc.pem"
jcrypto_out_ossl_plain_file_from_jcrypto="$jcrypto_this_dir/out-smime-env-kek-ossl-plain-jc.txt"
jcrypto_out_ossl_plain_file_from_ossl="$jcrypto_this_dir/out-smime-env-kek-ossl-plain-ossl.txt"
