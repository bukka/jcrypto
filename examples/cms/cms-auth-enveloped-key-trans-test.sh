...
jcrypto_out_enc_file="$jcrypto_this_dir/out-cms-auth-env-key-trans-enc.pem"
jcrypto_out_plain_file_from_jcrypto="$jcrypto_this_dir/out-cms-auth-env-key-trans-plain-jc.txt"
jcrypto_out_plain_file_from_ossl="$jcrypto_this_dir/out-cms-auth-env-key-trans-plain-ossl.txt"
jcrypto_out_ossl_enc_file="$jcrypto_this_dir/out-cms-auth-env-key-trans-ossl-enc.pem"
jcrypto_out_ossl_plain_file_from_jcrypto="$jcrypto_this_dir/out-cms-auth-env-key-trans-ossl-plain-jc.txt"
jcrypto_out_ossl_plain_file_from_ossl="$jcrypto_this_dir/out-cms-auth-env-key-trans-ossl-plain-ossl.txt"

echo "JCRYPTO ENCRYPT"
jcrypto cms encrypt -i "$jcrypto_this_dir/in-cms-data.txt" -f PEM -c aes-256-gcm \
...
jcrypto_openssl cms -decrypt -in "$jcrypto_out_ossl_enc_file" -inform PEM -aes-256-gcm \
...
jcrypto_openssl cms -decrypt -in "$jcrypto_out_enc_file" -inform PEM -aes-256-gcm \
...
jcrypto cms decrypt -i "$jcrypto_out_enc_file" -f PEM -c aes-256-gcm \
...
jcrypto cms decrypt -i "$jcrypto_out_ossl_enc_file" -f PEM -c aes-256-gcm \
