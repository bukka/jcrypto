...
jcrypto_out_sig_file="$jcrypto_this_dir/out-cms-signed-rsa.pem"
jcrypto_out_verify_file_from_jcrypto="$jcrypto_this_dir/out-cms-signed-rsa-verify-jc.txt"
jcrypto_out_verify_file_from_ossl="$jcrypto_this_dir/out-cms-signed-rsa-verify-ossl.txt"
jcrypto_out_ossl_sig_file="$jcrypto_this_dir/out-cms-signed-rsa-ossl.pem"
jcrypto_out_ossl_verify_file_from_jcrypto="$jcrypto_this_dir/out-cms-signed-rsa-ossl-verify-jc.txt"
jcrypto_out_ossl_verify_file_from_ossl="$jcrypto_this_dir/out-cms-signed-rsa-ossl-verify-ossl.txt"
