...
jcrypto_out_enc_file="$jcrypto_this_dir/out-cms-auth-env-kek-enc.pem"
jcrypto_out_plain_file_from_jcrypto="$jcrypto_this_dir/out-cms-auth-env-kek-plain-jc.txt"
jcrypto_out_plain_file_from_ossl="$jcrypto_this_dir/out-cms-auth-env-kek-plain-ossl.txt"
jcrypto_out_ossl_enc_file="$jcrypto_this_dir/out-cms-auth-env-kek-ossl-enc.pem"
jcrypto_out_ossl_plain_file_from_jcrypto="$jcrypto_this_dir/out-cms-auth-env-kek-ossl-plain-jc.txt"
jcrypto_out_ossl_plain_file_from_ossl="$jcrypto_this_dir/out-cms-auth-env-kek-ossl-plain-ossl.txt"
...
jcrypto cms decrypt -i "$jcrypto_out_ossl_enc_file" -f PEM -c aes-128-gcm \
	    --secret-key=000102030405060708090A0B0C0D0E0F --secret-key-id=C0FEE0 \
